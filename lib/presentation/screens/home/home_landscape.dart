...
class HomeLandscape extends StatefulWidget {
  final int? studentId;
  const HomeLandscape({Key? key, required this.studentId}) : super(key: key);
                            ...
                            Row(
                              children: [
                                Row(children: [
                                  ...
                                  Text(
                                    "${state.studentDashboard.studentInformation!.name!} ,",
                                    style: TextStyle(
                                        color: Colors.white, fontSize: 35.sp),
                                  ),
                                ]),
 ...
 _buildAssignmentCarouselSlider(StudentDashboardSuccess state) {
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                            fontSize: 25.sp, color: HexColor("#0F0A39")),
                      )
                    ],
                  ),
                ],
    ...
    return Stack(
      ...
      children: [
        ...
        Container(
            color: HexColor("#FFF7D6"),
            margin: EdgeInsets.fromLTRB(10.w, 0, 50.w, 0),
            child: Text(
